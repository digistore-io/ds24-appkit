...
//
// Two jobs, the same split as mcp-check:
//
...
// Kept in step with lib/api-keys/rules.ts by hand — this script cannot import
...
try {
  // Whose key. A member's view is the one that matters — same stance as
  // mcp-check.
