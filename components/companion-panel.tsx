...
//
// A second companion is a second entry in `lib/ai/companions.ts` and a second
...
import type { CompanionTurn } from "@/lib/ai/companion-rules";
...
export interface CompanionPanelProps {
  /** An id from `lib/ai/companions.ts`. */
  companionId: string;
