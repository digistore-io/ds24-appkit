...
// attempts, the verdict and the charge are `app/activity-actions.ts`, and this
...
import type { ActivityErrorCode } from "@/lib/learning/rules";
...
export interface ActivityPanelProps {
  /** An id from `lib/learning/activities.ts`. */
  activityId: string;
