...
//
// One list the app edits, exactly the role `lib/mcp/tools.ts` and
...
import type { CompanionFact, CustomerText } from "./companion";
 ...
 * `costsTokens` are read by `app/companion-actions.ts`, which asks `hasPlan()`
