...
# Consumer and information duties — Impressum, terms, and the wider map

Detail for the `compliance-check` skill: the Impressum and the terms (check 3 ·
`pages`) and the regimes beyond the core set (check 8 · `map`). The page
mechanics — where the legal files live, both languages, the placeholder marker
— stay in `SKILL.md`.
