...
import { findActivity } from "@/lib/learning/activities";
import { recordSubmission, resultFor } from "@/lib/learning/results";
import {
  ...
  return {
    ...
    stored: stored
      ? {
          ...
          // annotation and loses its type (CLAUDE.md → Dates and raw SQL).
